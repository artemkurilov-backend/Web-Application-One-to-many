...
public class BookController {
    ...
    public String listOfBooks(Model model,
                              ...
                              String sort,
                              @RequestParam(name = "searchBy", defaultValue = "author")
                              String searchBy,
                              @RequestParam(name = "deleteId", required = false)
                                  Long deleteId) {
    ...
    public String searchPage(@RequestParam String page,
        ...
        Page<Book> bookPage =
                service.getAllBooks(0, pageSize, "default");

        if((pageNumber - 1) >= bookPage.getTotalPages()) {

            model.addAttribute("noResultsPage", true);
        ...
        return "redirect:/BookController/ListOfBooks?page="
                + (pageNumber - 1);
    }
    ...
    public String searchBooks(@RequestParam String keyword,
        ...
        List<Book> books =
                service.searchBooks(keyword, searchBy);
