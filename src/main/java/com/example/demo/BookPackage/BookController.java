...
public class BookController {
    ...
    public String deleteStudent(@PathVariable Long id){
        ...
        return "redirect:/BookController/ListOfBooks?delete=true";
    }
    ...
    public String createBook(@ModelAttribute Book book){
        ...
        return "redirect:/BookController/ListOfBooks?success=true";
    }
    @GetMapping("/open/{id}")
    ...
    public String updateBook(@PathVariable Long id,
        ...
        return "redirect:/BookController/ListOfBooks?edit=true";
    }
    @GetMapping("/edit/{id}")
