...
public class StudentController {
    ...
    public String listOfUsers(Model model,
        ...
        if(deleteId != null){
            ...
            Student student =
                    service.findStudentById(deleteId);

            model.addAttribute("studentToDelete", student);
        }
    ...
    public String searchPage(@RequestParam String page,
        ...
        Page<Student> studentPage =
                service.getAllStudents(0, pageSize, "default");


        if((pageNumber - 1) >= studentPage.getTotalPages()) {
        ...
        return "redirect:/StudentController/ListOfStudents?page="
                + (pageNumber - 1);
    }
